...
- (IBAction)submitBtnClick:(id)sender
{
    ...
    [_lottery submitLotteryInfo:dict success:^{
        ...
        [UIAlertView popupAlertByDelegate:nil title:@"提交成功" message:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"WatchLiveLotteryTableViewCell" owner:self options:nil] objectAtIndex:0];
    }
