...
#define VHRES_personPlaceHold_Image [UIImage imageNamed:@"head50"]
...
-(void)layoutSubviews
{
    ...
    {
        [_bgView setBackgroundImage:[[UIImage imageNamed:@"chat_other"] resizableImageWithCapInsets:UIEdgeInsetsMake(30, 20, 5, 5)]forState:UIControlStateNormal];
    ...
    {
        [_bgView setBackgroundImage:[[UIImage imageNamed:@"chat_self"] resizableImageWithCapInsets:UIEdgeInsetsMake(30, 5, 5, 20)]forState:UIControlStateNormal];
...
-(void)layoutSubviews
{
    ...
    {
        text=@"赏给主播 大红包";
        [_giftImage setImage:[UIImage imageNamed:@"payMessage"]];
...
- (instancetype)initChatCellWithStyle:(UITableViewCellStyle)style reuseIdentifier:(nullable NSString *)reuseIdentifier
{
    if ((self = [super initChatCellWithStyle:style reuseIdentifier:reuseIdentifier])) {
        ...
        _qImageView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"questionMessage"]];
