...
- (void)setupConfigure
{
    ...
    if (_type ==3) {
        [_smallButton setBackgroundImage:[UIImage imageNamed:@"message_emoji"] forState:UIControlStateNormal];
    }else
    {
        [_smallButton setBackgroundImage:[UIImage imageNamed:@"message_emoji"] forState:UIControlStateNormal];
    }
    ...
    [_smallButton setBackgroundImage:[UIImage imageNamed:@"live_keyboard"] forState:UIControlStateSelected];
