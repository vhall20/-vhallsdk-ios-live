...
-(void)loadFaceDic
{
    _faceDic = [NSDictionary dictionaryWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"faceExpression" ofType:@"plist"]];
}
    ...
    for (int i = 0; i<Lines; i++)
    {
        for (int x = 0;x<NumPerLine;x++)
        {
            ...
            if (i*7+x+1 ==21) {
                ...
                NSString *imageStr = [NSString stringWithFormat:@"Expression_%d",
                                      index*20+i*7+x+1];
