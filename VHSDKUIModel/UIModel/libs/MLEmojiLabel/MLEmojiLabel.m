...
- (NSDictionary*)emojiDictForKey:(NSString*)key
{
    ...
    NSString *emojiFilePath = [meetingResourceBundlePath stringByAppendingPathComponent:key];
...
+ (NSDictionary *)emojiDictionary {
    ...
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        NSString *emojiFilePath = [meetingResourceBundlePath stringByAppendingPathComponent:@"MLEmoji_ExpressionImage.plist"];
